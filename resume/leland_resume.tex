  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem
        {Upgraded language integration process by implementing, documenting, and presenting an improved solution for adding new languages into printer receipt configurations.}
        \resumeItem
          {Reimplemented indexing strategy for an internal diagnostics tool used to query device metrics from Elasticsearch.}
        \resumeItem
...
\section{Projects}
  \resumeSubHeadingListStart
    \projectSubheading
      ...
      \resumeItemListStart
        \resumeItem
          {An implementation of an emulator for the Chip-8 virtual machine.}
         \resumeItem
          {Graphics and keyboard implemented with SDL2.}
      \resumeItemListEnd
